import { u as k, j as e } from "./index-DHZtUctP.mjs";
import { i as N, B as a, m as w } from "./heading-BU5ZMUV_.mjs";
import { k as C, l as y, m as z, X as M, n as H, o as $, p as P, q as D, C as I } from "./dialog-B8MooVkm.mjs";
/**
...
const S = [
  ...
  const [c, d] = k(!1), b = async () => {
    try {
      await navigator.clipboard.writeText(s), d(!0), setTimeout(() => d(!1), 2e3);
    } catch {
    }
  }, h = encodeURIComponent(r), l = encodeURIComponent(s), _ = encodeURIComponent(`${r} ${s}`);
  return /* @__PURE__ */ e.jsxs(C, { ...v, children: [
    ...
    /* @__PURE__ */ e.jsxs(z, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(a, { className: "[&_svg]:size-6! absolute -right-5 -top-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground", size: "lg", variant: "link", onClick: o, children: /* @__PURE__ */ e.jsx(M, { size: 24, strokeWidth: 1 }) }) }),
      /* @__PURE__ */ e.jsxs(H, { className: "relative -mt-5", children: [
        ...
        t && /* @__PURE__ */ e.jsx(P, { className: "mb-0 pb-0 pt-1 text-lg text-foreground", children: t })
      ] }),
      /* @__PURE__ */ e.jsxs("a", { className: "hover:border-muted-foreground/40 flex flex-col items-stretch overflow-hidden rounded-md border transition-all", href: s, rel: "noopener noreferrer", target: "_blank", children: [
      ...
      /* @__PURE__ */ e.jsx(D, { className: "justify-between gap-6", children: x ? /* @__PURE__ */ e.jsx(a, { className: "cursor-pointer", type: "submit", onClick: o, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on X", className: "hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4", href: `https://twitter.com/intent/tweet?text=${h}%0A${l}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 24 24", children: /* @__PURE__ */ e.jsx("path", { className: "social-x_svg__x", d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) }) }),
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on Threads", className: "hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4", href: `https://threads.net/intent/post?text=${_}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on Facebook", className: "hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${l}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
        ...
        /* @__PURE__ */ e.jsxs(
          a,
          {
            ...
            onClick: b,
            children: [
              c ? /* @__PURE__ */ e.jsx(I, {}) : /* @__PURE__ */ e.jsx(V, {}),
              c ? "Copied!" : "Copy link"
            ]
          }
        )
...
//# sourceMappingURL=post-share-modal-S1xWFxiy.mjs.map
